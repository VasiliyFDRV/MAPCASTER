...
Item {
    ...
    NeumoInsetBevel {
        ...
        darkOffset: root.effectiveInsetOffset
        lightOffset: root.effectiveInsetLightOffset
        darkRadius: root.effectiveInsetDarkRadius
        lightRadius: root.effectiveInsetLightRadius
        active: true
    }
