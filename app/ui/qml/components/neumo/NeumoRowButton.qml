...
Item {
    ...
    NeumoRaisedSurface {
        ...
        shadowOffset: rowButton.dragging
            ...
            : (rowButton.hovered ? (rowButton.theme ? rowButton.theme.rowShadowOffsetHover : 5.6) : (rowButton.theme ? rowButton.theme.rowShadowOffset : 4.5))
        shadowRadius: rowButton.dragging
            ? (rowButton.theme ? rowButton.theme.rowShadowRadiusDrag : 11)
            : (rowButton.hovered ? (rowButton.theme ? rowButton.theme.rowShadowRadiusHover : 10.8) : (rowButton.theme ? rowButton.theme.rowShadowRadius : 10))
        ...
        shadowLightColor: rowButton.dragging
            ...
            : (rowButton.hovered
                ? (rowButton.theme ? rowButton.theme.rowShadowLightColorHover : "#AD55565C")
